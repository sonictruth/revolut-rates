...
var AppComponent = (function () {
    function AppComponent(http) {
        this.http = http;
        this.displayedColumns = ['from', 'to', 'ammount', 'result'];
        ...
        this.storageName = 'rates';
        this.userExchanges = [];
        this.currencies = ['BTC', 'ETH', 'LTC', 'EUR', 'GBP', 'USD', 'AUD', 'CAD', 'CZK', 'DKK', 'HKD', 'HUF', 'ILS', 'JPY',
    ...
    AppComponent.prototype.httpRequest = function () {
        var x = this.http.get('https://cors-anywhere.herokuapp.com/https://www.revolut.com/api/quote/internal/BTCGBP')
            .map(function (res) { return res.json(); });
        __WEBPACK_IMPORTED_MODULE_5_rxjs_Observable__["a" /* Observable */].forkJoin([x])
    ...
    AppComponent.prototype.loadRates = function () {
        ...
        displayRates = this.userExchanges.map(function (ex) {
            return {
                ammount: ex.ammount,
                to: ex.to,
                from: ex.from,
        ...
        this.dataSource = new __WEBPACK_IMPORTED_MODULE_1__angular_material__["B" /* MatTableDataSource */](displayRates);
    };
    ...
    AppComponent.prototype.loadFromStorage = function () {
